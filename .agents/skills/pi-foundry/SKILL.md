...
Thin azd adapter in the same repo
  ...
  - generated by render: agent.yaml, agent.manifest.yaml, .azd/pi-foundry/Dockerfile, pi-foundry.lock.yaml, generated/agent*.yaml
        |
        v
